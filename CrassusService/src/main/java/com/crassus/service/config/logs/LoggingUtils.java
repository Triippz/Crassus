package com.crassus.service.config.logs;
...
public final class LoggingUtils {
  ...
  public static void addLogstashTcpSocketAppender(
    ...
    String customFields,
    CrassusProperties.Logging.Logstash logstashProperties
  ) {
  ...
  public static void addContextListener(
    LoggerContext context,
    String customFields,
    CrassusProperties.Logging properties
  ) {
  ...
  private static GlobalCustomFieldsJsonProvider<ILoggingEvent> customFieldsJsonProvider(
    ...
    GlobalCustomFieldsJsonProvider<ILoggingEvent> customFieldsJsonProvider =
  ...
  private static class LogbackLoggerContextListener
    extends ContextAwareBase
    implements LoggerContextListener {

    private final CrassusProperties.Logging loggingProperties;
    private final String customFields;

    private LogbackLoggerContextListener(
      CrassusProperties.Logging loggingProperties,
      String customFields
    ) {
    ...
    public void onStart(LoggerContext context) {
      ...
      if (this.loggingProperties.getLogstash().isEnabled()) {
        LoggingUtils.addLogstashTcpSocketAppender(
          context,
          this.customFields,
          this.loggingProperties.getLogstash()
        );
      }
    }
