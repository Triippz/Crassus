package com.crassus.service.security;
...
public final class SecurityUtils {
  ...
  public static final String CLAIMS_NAMESPACE = "https://www.crassuscommerce.com/";
  ...
  private static String extractUserId(Authentication authentication) {
    if (authentication == null) {
      ...
      return (String) ((JwtAuthenticationToken) authentication).getToken()
        .getClaims()
        .get("sub");
  ...
  public static List<GrantedAuthority> extractAuthorityFromClaims(
  ...
  private static List<GrantedAuthority> mapRolesToGrantedAuthorities(
