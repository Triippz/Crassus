package com.crassus.service.util;
...
public class OAuth2TestUtil {
  ...
  public static OAuth2AuthenticationToken testAuthenticationToken(
    ...
    claims.put("email", "john.doe@crassuscommerce.com");
    claims.put("roles", authorities);

    return authenticationToken(claims);
  }

  public static OAuth2AuthenticationToken authenticationToken(
    ...
    if (!claims.containsKey("email")) {
      claims.put("email", "jane.doe@crassuscommerce.com");
    }
    ...
    Collection<GrantedAuthority> authorities = SecurityUtils.extractAuthorityFromClaims(
      claims
    );
